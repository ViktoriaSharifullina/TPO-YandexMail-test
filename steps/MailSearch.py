...
def step_impl(context):
    wait = WebDriverWait(context.driver, 40)
    find_by_xpath(wait,
                  '/html/body/div[3]/div[2]/div[7]/div/div[2]/div/div/div[1]/div[2]/div/div/div/div[1]/form/button').click()
...
@step("I enter not existed topic {topic} a message")
def step_impl(context, topic):
    wait = WebDriverWait(context.driver, 40)
    search_input = find_by_xpath(wait,
                                 '/html/body/div[3]/div[2]/div[7]/div/div[2]/div/div/div[1]/div[2]/div/div/div/div[1]/form/div/span/input')
