...
try:
    ...
    button_delay = wait.until(ec.visibility_of_element_located((By.XPATH,
                                                                '/html/body/div[3]/div[2]/div[10]/div/div/div[1]/div/div/div/div[1]/div[1]/div[2]/div/div[1]/div[2]/button')))
    button_delay.click()
    tomorrow = wait.until(ec.visibility_of_element_located((By.XPATH,
                                                            '/html/body/div[37]/div[1]/div[1]/div[2]')))
    # tomorrow.click().perform()
    # ActionChains(driver).move_to_element(tomorrow).click().perform()
    action = ActionChains(driver)
    action.context_click(tomorrow)
